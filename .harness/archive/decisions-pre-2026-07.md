# Decision log — archive: pre-2026-07

Lines 1-4092 of `.harness/decisions.md` as-of ce12c42 (the original header +
everything before the first 2026-07 promoted block), moved VERBATIM on
2026-07-12 by run repo-efficiency-20260712-112504 per
docs/efficiency-audit-2026-07-12-newlens.md §5 QW1/§4.1: 118 dated entries
(2026-06-02 D1 … 2026-06-12). APPEND-FROZEN — new entries go to the live file.
The snapshot below is verbatim history INCLUDING its now-obsolete header
instructions (rules, entry format, "(append below this line)"); this preamble
takes precedence: nothing is appended or edited here.
